...
const scale = useTransform(scrollYProgress, [0, 0.85], [0.6, 1]);
  ...
  return (
    <div
      ...
      className="relative min-h-screen h-[160vh] w-full flex items-start justify-center bg-black"
    >
      <motion.div className="sticky top-0 min-h-screen w-full bg-primary/50 flex items-center justify-start" style={{scale: scale}}>
