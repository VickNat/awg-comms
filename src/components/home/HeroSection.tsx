...
const HeroSection = () => {
  return (
    <div className="relative w-full min-h-screen h-[100vh] object-center overflow-hidden flex bg-background">
      ...
      <div className="absolute flex flex-col gap-10 h-[100vh] w-full justify-center items-center backdrop-blur-xs mask-x-from-70%">
